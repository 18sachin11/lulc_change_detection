...
if uploaded_file_1 and uploaded_file_2:
    try:
        ...
        if lc1.shape != lc2.shape:
            ...
            st.download_button(
                label="Download Transition Map (.tif)",
                data=buffer_trans,
...
if uploaded_file_1 and uploaded_file_2:
    try:
        ...
        if lc1.shape != lc2.shape:
            ...
            # 📥 Download Transition Map as TIFF
            st.subheader('📥 Download Transition Map')
            ...
            # 📈 Future Prediction (Markov Chain)
